...
# Title
heading = tk.Label(root, text="To-Do", bg="#A2D2FF", fg="#FFFFFF", font=("Gill Sans", 20, "bold"))
...
# Input
task_input = tk.Entry(first_frame, width=16, highlightthickness=0, relief="ridge", font=("Gill Sans", 20))
task_input.grid(row=0, column=1, padx=10)
add_button = tk.Button(first_frame, text="+", width=5, command=add_task, bg="#C0AFE2", fg="#FFFFFF", borderwidth=0,
                       font=("Gill Sans", 20, "bold"))
add_button.grid(row=0, column=0)

# Display Task
task_list = tk.Listbox(second_frame, height=10, width=30, borderwidth=0, bg="#FFAFCC", font=("Gill Sans", 15))
